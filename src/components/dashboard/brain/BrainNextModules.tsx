import { Lock, ArrowRight, Store, Shield } from "lucide-react";
...
const modules = [
  {
    id: "GEISER_06",
    name: "Marketplace",
    description: "Publish and monetize agents, workflows and APIs in a shared ecosystem",
    icon: Store,
...
export function BrainNextModules() {
  return (
